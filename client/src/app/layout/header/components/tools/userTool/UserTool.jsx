...
import SignedIn from "@/app/layout/header/components/tools/userTool/SignedIn";
import NotSignedIn from "@/app/layout/header/components/tools/userTool/NotSignedIn";
  ...
  return (
    <div className="nav-bar__tools__user">
      <div
        className={
          ifHide
            ? "nav-bar__tools__user__icon-container"
            : "nav-bar__tools__user__icon-container nav-bar__tools__user__icon-container--active"
        }

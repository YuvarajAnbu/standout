...
function NavLinks({ setBlackBox }) {
  ...
  useEffect(() => {
    const overlay = document.querySelector("header .black-box");
    ...
    overlay.addEventListener("click", hideNavigation);
    return () => overlay.removeEventListener("click", hideNavigation);
  }, [setBlackBox]);

  ...
  return (
    <div className="footer__t-c">
      ...
      <p>
        ...
        of stand out's Website, located at{" "}
        <Link to="https://www.standout.com" />{" "}
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use stand out if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of New york. Any use of the above terminology
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing stand out, you agreed to use
        cookies in agreement with the stand out's Privacy Policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, stand out and/or its licensors own the
        intellectual property rights for all material on stand out. All
        intellectual property rights are reserved. You may access this from
        stand out for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from stand out</li>
        <li>Sell, rent or sub-license material from stand out</li>
        <li>Reproduce, duplicate or copy material from stand out</li>
        <li>Redistribute content from stand out</li>
      </ul>
      <p>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. stand
        out does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of stand out,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, stand out shall not be liable for
      ...
      <p>
        stand out reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant stand out a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of stand out; and (d) the link is
      ...
      <p>
        ...
        e-mail to stand out. Please include your name, your organization name,
      ...
      <p>
        No use of stand out's logo or other artwork will be allowed for linking
